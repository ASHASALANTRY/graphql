...
public class ReactiveService {
	  public static Flux<String> stringNumbersFlux() {
	    ...
	    public static Flux<User> userFlux() {
	        return Flux.just(
	                new User(1, "Lionel", "Messi",40),
	                new User(2, "Cristiano", "Ronaldo",40),
	                new User(2, "Diego", "Maradona",40),
	                new User(4, "Zinedine", "Zidane",40),
	                new User(5, "Jürgen", "Klinsmann",40),
	                new User(6, "Gareth", "Bale",40)
	        ).delayElements(Duration.ofSeconds(1));
	    }
